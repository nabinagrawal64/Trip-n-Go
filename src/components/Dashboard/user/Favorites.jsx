...
const Favorites = () => {
    ...
    return (
        <div className="text-white min-h-screen p-6">
            <h2 className="lg:text-2xl sm:text-xl text-lg mx-auto font-bold">Favorites</h2>
            ...
            {cars.map((car, index) => (
                ...
                >
                    {/* Car Details */}
                    <div className="lg:p-4 flex sm:p-2.5 mt-1 sm:mt-2 xl:tracking-widest">
                        {/* Car Image */}
                            <button
                            ...
                            <img
                                src={car.image}
                                alt={car.name}
                                className="w-auto lg:h-64 sm:h-40 h-32 object-fit xl:mr-56 sm:mr-8 mr-3 rounded-lg"
                            />
