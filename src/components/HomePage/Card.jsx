...
export default function CarCard ({car: { image, name, company, rating, reviews, location, seats, price}}) {
    return (
        <div className="xl:w-[320px] lg:w-[300px] md:w-[210px] sm:w-[170px] w-[110px] bg-[#313131] text-white rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="relative">
                ...
                <div className="absolute xl:-bottom-4 md:-bottom-3 -bottom-2 lg:right-2 sm:right-1 right-0.5 bg-black lg:px-2 px-1 lg:text-xs rounded-md flex items-center gap-1">
                    ...
                    <span className="font-semibold lg:text-md md:text-xs sm:text-[10px] text-[7px]">{rating}</span>
            ...
            <div className="lg:p-4 sm:p-2.5 p-1.5 mt-1 sm:mt-2">
                <h2 className="lg:text-lg truncate sm:text-sm text-xs font-bold">{name}</h2>
                <p className="text-gray-400 lg:text-sm sm:text-xs text-[8px]">- By {company}</p>
